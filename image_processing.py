	...
	if (pixel[0] <= 245):
		if (pixel[1] <= 245):
			if (pixel[2] <= 245):
				...
				return (pixel[0]+10,pixel[1]+10,255)
		else:
			if (pixel[2] <= 245):
				return (pixel[0]+10,255,pixel[2]+10)
			else:
				return (pixel[0]+10,255,255)
	else:
		if (pixel[1] <= 245):
			if (pixel[2] <= 245):
				return (255,pixel[1]+10,pixel[2]+10)
			else:
				return (255,pixel[1]+10,255)
		else:
			if (pixel[2] <= 245):
				return (255,255,pixel[2]+10)
			else:
				return (255,255,255)
	...
	if (pixel[0] >= 10):
		if (pixel[1] >= 10):
			if (pixel[2] >= 10):
				...
				return (pixel[0]-10,pixel[1]-10,0)
		else:
			if (pixel[2] >= 10):
				return (pixel[0]-10,0,pixel[2]-10)
			else:
				return (pixel[0]-10,0,0)
	else:
		if (pixel[1] >= 10):
			if (pixel[2] >= 10):
				return (0,pixel[1]-10,pixel[2]-10)
			else:
				return (0,pixel[1]-10,0)
		else:
			if (pixel[2] >= 10):
				return (0,0,pixel[2]-10)
			else:
				return (0,0,0)
...
def darkn(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = darkin(pixels3d[x,y])


def lightn(image_surf):
    ...
    for x in range(rows):
        for y in range(cols):
            pixels3d[x,y] = lightin(pixels3d[x,y])
